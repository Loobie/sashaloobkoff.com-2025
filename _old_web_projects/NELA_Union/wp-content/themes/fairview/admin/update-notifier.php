...
define( 'NOTIFIER_THEME_NAME', 'WP Fairview' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'travler' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://wp.contempographicdesign.com/wp_travler/changelog/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
