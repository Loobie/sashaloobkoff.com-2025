...
function dw_page_editor_add_tinymce_plugin($plugin_array) {
   $plugin_array['dw_page_projects'] = DW_PAGE_URI .'inc/assets/admin/js/dw-page-project-shortcode.js';
   $plugin_array['dw_page_testimonial'] = DW_PAGE_URI .'inc/assets/admin/js/dw-page-testimonial-shortcode.js';
   $plugin_array['dw_page_client'] = DW_PAGE_URI .'inc/assets/admin/js/dw-page-client-shortcode.js';
   $plugin_array['dw_page_team'] = DW_PAGE_URI .'inc/assets/admin/js/dw-page-team-shortcode.js';
   return $plugin_array;
}
