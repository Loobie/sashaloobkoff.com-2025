	...
	<td class="mainTable">
		...
		<?php
				...
				<tr><td>&nbsp;<td align='center'  class='xml'>
						<a href='http://www.sashaloobkoff.com/store/podcast/momibello.xml' target='_xmlWindow'><img src='http://www.sashaloobkoff.com/store/podcast/xml_title.gif' border='0' /><img src='http://www.sashaloobkoff.com/store/podcast/xml_02.gif' border='0'  alt='Right click this button to subscribe'/></a><a href='#' onMouseDown=\"javascript:openWindow('http://www.sashaloobkoff.com/store/podcast/help.php')\"><img src='http://www.sashaloobkoff.com/store/podcast/xml_help.gif' border='0'  alt='Click for help... you must allow popups for this page'/></a>
				</td></tr>";
				...
				{
				////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				// this is for the Coco B's in the alt section... replace single qoute
				$bandName=$row['bandName'];	
				$bandName=str_replace("'","&lsquo;",$bandName);
				//echo $bandName;
				
				//echo addslashes($row['bandName']);					
			?>
				<td class='products'>
				 <center>
					<table class='product' cellpadding='0' cellspacing='0'>
						<!-- image insertion -->
						<td><a href='individualProduct.php?pid=<?=$row['pid']?>' border='0'><img src='art/cds/<?=$row['pid']?>.gif' alt='Click for for more info on <?= $bandName?> :: <?=$row['title']?>'  width='170' height='170' border='0'></a></td>
					  </tr> 
						<?PHP
						/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
						// if not clothing, insert band name
						
						// make band name all caps
						$band = strtoUpper($row['bandName']);
						// print band name
						if (productType != 2)
						{
						print "
					  <tr>
						<td class='text' align='center'><span class='title'>$band</span></td>
					  </tr>";
					  }
					  ?>
					  <tr class='border'> 
